...
//! - All application code data access must fo through the Model layer.
...
//!   CRUD and other data access methods on a given "entry"
//!   (e.g., `Task`, `Project`).
//!   (`Bmc` is shor for Backend Model Controller).
